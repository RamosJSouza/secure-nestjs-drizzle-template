...
| `security.risk.login_blocked` | Score de risco ≥ 80 (crítico) |
| `security.risk.elevated_login` | Score de risco médio/alto |
| `security.session.limit_eviction` | Limite de sessões excedido (máx. 10) |
